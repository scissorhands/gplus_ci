...
require_once GOOGLE_API_PATH . 'Google/Auth/AssertionCredentials.php';
require_once GOOGLE_API_PATH . 'Google/Cache/File.php';
require_once GOOGLE_API_PATH . 'Google/Cache/Memcache.php';
require_once GOOGLE_API_PATH . 'Google/Config.php';
require_once GOOGLE_API_PATH . 'Google/Collection.php';
require_once GOOGLE_API_PATH . 'Google/Exception.php';
require_once GOOGLE_API_PATH . 'Google/IO/Curl.php';
require_once GOOGLE_API_PATH . 'Google/IO/Stream.php';
require_once GOOGLE_API_PATH . 'Google/Model.php';
require_once GOOGLE_API_PATH . 'Google/Service.php';
require_once GOOGLE_API_PATH . 'Google/Service/Resource.php';
